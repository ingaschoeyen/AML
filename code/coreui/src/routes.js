...
// Map
const MapPage = React.lazy(() => import('./views/map/Map'))
// Network
const NetworkPage = React.lazy(() => import('./views/network/Network'))

// Assets
const AssetsPage = React.lazy(() => import('./views/assets/Assets'))
...
export const routes = [
  ...
  { path: '/network', name: 'Network', element: NetworkPage },
  { path: '/assets', name: 'Assets', element: AssetsPage },
